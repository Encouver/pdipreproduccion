...
/**
 * This is the model class for table "pdi.cronogramaexport".
 *
 * The followings are the available columns in table 'pdi.cronogramaexport':
 * @property integer $id
 ...
 */
class Cronogramaexport extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('insumo, cod_arancelario, unidad_id, cantidad, costo_total, fecha_estimada, pais_destino, fecha_registro, proyecto_id', 'required'),
			array('cod_arancelario, unidad_id, cantidad, costo_total, pais_destino, proyecto_id', 'numerical', 'integerOnly'=>true),
			array('insumo', 'length', 'max'=>30),
			array('valido', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, insumo, cod_arancelario, unidad_id, cantidad, costo_total, fecha_estimada, pais_destino, fecha_registro, valido, proyecto_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Cronogramaexport the static model class
	 */
