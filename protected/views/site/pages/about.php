		...
		<div class="row">
			<div class="col-xs-6 col-md-6">
					<div class="form-group">
						...
						<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Inversiones Exteriror C.A.">
					</div>
				</div>
				<div class="col-xs-6 col-md-6">
					<div class="form-group">
				    	<label for="exampleInputPassword1">RIF</label>
				    	<input type="text" class="form-control" id="exampleInputPassword1" placeholder="J234785090">
				  	</div>
				</div>
		</div>
</fieldset>
